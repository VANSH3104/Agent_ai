...
export const WorkflowBuilder = ({ id }: { id: string }) => {
  ...
  const handleSaveConfig = async (nodeId: string, data: any) => {
    console.log('Saving config for node:', nodeId, data);
    ...
    // Find the node to get current data for merging
    const currentNode = nodes.find(n => n.id === nodeId);
    const mergedData = currentNode ? { ...currentNode.data, ...data } : data;
